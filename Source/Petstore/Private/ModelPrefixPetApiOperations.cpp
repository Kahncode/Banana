...
inline FString ToString(const ModelPrefixPetApi::FindPetsByStatusRequest::StatusEnum& Value)
{
	switch (Value)
	{
	case ModelPrefixPetApi::FindPetsByStatusRequest::StatusEnum::Available:
		return TEXT("available");
	case ModelPrefixPetApi::FindPetsByStatusRequest::StatusEnum::Pending:
		return TEXT("pending");
	case ModelPrefixPetApi::FindPetsByStatusRequest::StatusEnum::Sold:
		return TEXT("sold");
	}

	UE_LOG(LogPetstore, Error, TEXT("Invalid ModelPrefixPetApi::FindPetsByStatusRequest::StatusEnum Value (%d)"), (int)Value);	
	return TEXT("");
}
...
inline void WriteJsonValue(JsonWriter& Writer, const ModelPrefixPetApi::FindPetsByStatusRequest::StatusEnum& Value)
{
	WriteJsonValue(Writer, ToString(Value));
}

inline bool TryGetJsonValue(const TSharedPtr<FJsonValue>& JsonValue, ModelPrefixPetApi::FindPetsByStatusRequest::StatusEnum& Value)
{
	FString TmpValue;
