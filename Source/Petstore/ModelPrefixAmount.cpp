...
namespace CppNamespace 
{
	...
	void ModelPrefixAmount::WriteJson(JsonWriter& Writer) const
	{
	...
	bool ModelPrefixAmount::FromJson(const TSharedPtr<FJsonObject>& JsonObject)
	{
